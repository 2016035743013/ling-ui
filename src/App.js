  ...
  render () {
    return (
      <div className="App">
        ...
        <Button type='danger' loading={true} size='large'> 我是搜索按钮 </Button>
        <Button type='danger' loading={true} size='small'> 我是搜索按钮 </Button>
        <Button type='danger' ghost={true}> 我是搜索按钮 </Button>
        <Button type='danger' ghost={true} onClick={this.handleClick}> 我是点击按钮 </Button>
      </div>
    );
  }
}
